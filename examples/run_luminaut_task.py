...
local_model_config = {
    "task_type": "general_9_action_flow",
    "model_config": {
        "model_name": "oppo-test-step-gui",
        "model_provider": "luminaut",
        "args": {
            "temperature": 0.1,
            "top_p": 0.95,
...
if __name__ == "__main__":
    ...
    l2_server = LuminautServer(tmp_server_config)
    ...
    # Disable auto reply
    extra_info = {"device_info" : device_info,
                  "max_steps" : tmp_rollout_config["max_steps"]}

    evaluate_task_on_device(l2_server, device_info, task, tmp_rollout_config, extra_info, reflush_app=True)
